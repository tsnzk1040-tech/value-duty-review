...
export function buildClosingInstructions(input: ClosingGenerateInput): string {
  ...
  return [
    ...
    "読んだ人が『ちょっとやってみようかな』『そういう考え方もあるんだ』と感じる一文にする。",
    "布教・号令・空スローガンにしない。上司として軽く誘うカジュアルな距離感。",
    "",
    "【必須】",
    "- 所感本文の具体に対応した締めだけ出す。汎用の『みんなで頑張りましょう』単体は不合格。",
    "- 所感は共感・提案・薄い問いまで。締めは『試してみよう／考えてみよう』級のやわらかい誘い。",
    ...
    "- 聞き方を先に決める一手、明日の一件で試してみませんか！",
    "- 『できない』の手前に分解がある、と思えたら十分ですね。また共有しましょう！",
    "",
    "【悪い例】",
    "- 皆さんと一緒にやっていきましょう。",
    "- 理念浸透を進めていきましょう。",
